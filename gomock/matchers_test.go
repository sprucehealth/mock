...
//go:generate mockgen -destination internal/mock_gomock/mock_matcher.go github.com/sprucehealth/mock/gomock Matcher
...
import (
	...
	"github.com/sprucehealth/mock/gomock/internal/mock_gomock"
)
